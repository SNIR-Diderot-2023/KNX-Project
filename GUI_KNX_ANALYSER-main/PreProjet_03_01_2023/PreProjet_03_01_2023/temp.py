...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        image_path = os.path.join(os.path.dirname(os.path.realpath(
            __file__)), "D:\Users\mehdi.soukker\Downloads\GUI_KNX_ANALYSER-main\PreProjet_03_01_2023\Nouveau projet.png")
        self.logo_image = customtkinter.CTkImage(Image.open(os.path.join(
            image_path, "D:\Users\mehdi.soukker\Downloads\GUI_KNX_ANALYSER-main\PreProjet_03_01_2023\Nouveau projet.png")), size=(26, 26))
        self.large_test_image = customtkinter.CTkImage(Image.open(
            os.path.join(image_path, "D:\Users\mehdi.soukker\Downloads\GUI_KNX_ANALYSER-main\PreProjet_03_01_2023\Nouveau projet.png")), size=(500, 150))
        self.image_icon_image = customtkinter.CTkImage(Image.open(
            os.path.join(image_path, "D:\Users\mehdi.soukker\Downloads\GUI_KNX_ANALYSER-main\PreProjet_03_01_2023\Nouveau projet.png")), size=(20, 20))
